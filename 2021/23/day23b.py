...
start = time.time()
initState = open('2021/23/inputB').read().splitlines()
fishVals = {'A':1,'B':10,'C':100,'D':1000}
finalStates = {'A':{(3,2),(3,3),(3,4),(3,5)},'B':{(5,2),(5,3),(5,4),(5,5)},'C':{(7,2),(7,3),(7,4),(7,5)},'D':{(9,2),(9,3),(9,4),(9,5)}}
...
while statesToCheck:
    ...
    for fish in fishes:
        if not fishDone(fish,fishes):
            ...
            numDone += 1
print("Answer part B: minimum energy is {}, took {:.2f} s".format(ansA,time.time()-start))
