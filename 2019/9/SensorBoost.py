...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  9 08:36:25 2019
...
intcode = open('2019/9/input','r')
code = intcode.read()
intcode.close()
#code = '104,1125899906842624,99'
codeList = [ int(x) for x in code.split(',')]
print('Length of program = {}'.format(len(codeList)))
intComp = IntComputer(codeList)
inputs = [2]
outputs = intComp.runProgram(inputs)
print(outputs)
print('Number of instructions = {}'.format(intComp.numInstructions))
print('Length of memory = {}'.format(len(intComp.codeList)))