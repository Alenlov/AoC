...
int main(int argc, char const *argv[])
{
    ...
    //comp.print = true;
    long iterA{comp.runProgram()};

    std::cout << "Answer part A: " << sumOfFactors(comp.m[2]) << std::endl;

    /* for (auto [i,n] : comp.instVisited)
    {
        std::cout << "Instruction " << i << " executed " << n << " times" << std::endl;
    } */

    comp.instVisited.clear();
    comp.m = {1,0,0,0,0,0};
    comp.runProgram(5*iterA);
    ...
    std::cout << "Answer part B: " << sumOfFactors(comp.m[2]) << std::endl;
